...
namespace SupportTicketApplication
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            var tickets = JsonConvert.DeserializeObject<List<SupportTicket>>(handler.Get("http://localhost/SupportTicketAPI/ticket/getall").Result);
            var context = DataContext as MainViewModel;

            tickets.ForEach(context.SupportTickets.Add);
        }
        ...
        private async void save_Click(object sender, RoutedEventArgs e)
        {
            ...
            (DataContext as MainViewModel).Save_List();
        }
        ...
        private async void EditTask_Click(object sender, RoutedEventArgs e)
        {
            ...
            var diag = new TicketDialog((DataContext as MainViewModel).SupportTickets, (DataContext as MainViewModel).SelectedTicket);
            await diag.ShowAsync();
        }
        private async void EditAppointment_Click(object sender, RoutedEventArgs e)
        {

            var diag = new AppointmentDialog((DataContext as MainViewModel).SupportTickets, (DataContext as MainViewModel).SelectedTicket);
            await diag.ShowAsync();
        }
        ...
        private async void Search_Click(object sender, RoutedEventArgs e)
        {
            ...
            await diag.ShowAsync();
            (DataContext as MainViewModel).SearchTicket();
